...
<td><input type="text" name="email" value="<?= $user_object->user_email ?>" size="48"/></td>
</tr>

<tr valign="top">
<th scope="row">First Name:</th>
<td><input type="text" name="first_name" value="<?= $user_object->first_name ?>" size="48"/></td>
</tr>

<tr valign="top">
<th scope="row">Last Name:</th>
<td><input type="text" name="last_name" value="<?= $user_object->last_name ?>" size="48"/></td>
</tr>

<tr valign="top" style="display:none">
<th scope="row" style="display:none">Domain:</th>
<td style="display:none"><input type="text" name="domain" value="<?= $domain ?>" size="48"/></td>
</tr>
